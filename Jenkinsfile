...
pipeline {
    ...
    stages {
        ...
        stage('Checkout To Mcroservice Branch'){
            steps{
                git branch: 'app-shipping-service', url: 'https://github.com/asaphir/realworld-microservice-project.git'
            }
        }
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'docker') {
                        sh "docker build -t asaphir/shippingservice:latest ."
                    }
                }
            }
        }
        ...
        stage('Snyk SCA Test | Dependencies') {
            steps {
                sh "${SNYK_HOME}/snyk-linux test --docker asaphir/shippingservice:latest || true" 
            }
        }
        ...
        //         script {
        //             withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'docker') {
        //                 sh "docker push asaphir/shippingservice:latest "
        //             }
        //         }
        //     }
        // }
    ...
    always {
        ...
        slackSend channel: '#ans0116-multi-microservices-project-alerts', //update and provide your channel name
